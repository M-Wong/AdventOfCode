...
private class DayProvider : ArgumentsProvider {
	override fun provideArguments(context: ExtensionContext?): Stream<out Arguments> {
		return Stream.of(
			...
			ControlAnswer(Day5(), 3, 14),
			ControlAnswer(Day6(), 4277556, 3263827),
			ControlAnswer(Day7(), 21, 40),
			ControlAnswer(Day8(), 40, 25272),
			ControlAnswer(Day9(), 50, 24),
			ControlAnswer(Day10(), 7, 33),
			ControlAnswer(Day11(), 5, 2),
